                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+017000000059"><i class="fa fa-phone"></i>+017000000059</a></li>
                            <li><a href="mailto:contact@surfsidemedia.in"><i class="fa fa-envelope"></i>
                            contact@chandan.com</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="tel:+017000000059"><i class="fa fa-phone"></i>
                            +017000000059</a></li>
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            ...
                            <li>
                                <i class="fa fa-envelope"></i> <a href="mailto:contact@surfsidemedia.in">contact@chandan.com</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+017000000059">+017000000059</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-envelope"></i> <a href="mailto:contact@chandan.com">contact@chandan.com</a>
                            </li>
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+017000000059">+017000000059</a>
                            </li>
                        </ul>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2021 Chandan. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
